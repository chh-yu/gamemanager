define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'prize/pool/index' + location.search,
                    add_url: 'prize/pool/add',
                    edit_url: 'prize/pool/edit',
                    del_url: 'prize/pool/del',
                    multi_url: 'prize/pool/multi',
                    import_url: 'prize/pool/import',
                    table: 'prize_pool',
                }
            });
