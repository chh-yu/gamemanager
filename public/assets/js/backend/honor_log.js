define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'honor_log/index' + location.search,
                    add_url: 'honor_log/add',
                    edit_url: 'honor_log/edit',
                    del_url: 'honor_log/del',
                    multi_url: 'honor_log/multi',
                    import_url: 'honor_log/import',
                    table: 'honor_log',
                }
            });
