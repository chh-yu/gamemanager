define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'prizepool/index' + location.search,
                    add_url: 'prizepool/add',
                    edit_url: 'prizepool/edit',
                    del_url: 'prizepool/del',
                    multi_url: 'prizepool/multi',
                    import_url: 'prizepool/import',
                    table: 'prize_pool',
                }
            });
