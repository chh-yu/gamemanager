define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'relationship/index' + location.search,
                    add_url: 'relationship/add',
                    edit_url: 'relationship/edit',
                    del_url: 'relationship/del',
                    multi_url: 'relationship/multi',
                    import_url: 'relationship/import',
                    table: 'relationship',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'friend_users_id', title: __('Friend_users_id')},
