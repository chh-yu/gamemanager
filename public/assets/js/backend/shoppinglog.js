define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'shoppinglog/index' + location.search,
                    add_url: 'shoppinglog/add',
                    edit_url: 'shoppinglog/edit',
                    del_url: 'shoppinglog/del',
                    multi_url: 'shoppinglog/multi',
                    import_url: 'shoppinglog/import',
                    table: 'shopping_log',
                }
            });
